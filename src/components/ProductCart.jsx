...
const ProductCart = ({children,isOpen,src,cost,productName,material,productClass,productCartId,starRate,explanationProductClass,pictureProductClass,starClass}) => {

  // console.log("starRate",starRate);

  return (
    <div className={`${productClass} `}>
        <PictureProduct isOpen={isOpen} picClass={pictureProductClass} src={src} pictureProductId={productCartId}/>
